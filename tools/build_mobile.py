...
def transform(html):
    ...
    html=html.replace('</head>', '<script src="images/combat/effects.js"></script><script src="audio/combat/sound.js"></script><style>.zr-raid-head{flex-wrap:wrap;gap:10px}.zr-raid-head>div{font-size:clamp(20px,5.8vw,28px)!important;gap:14px!important;line-height:1.4;flex-wrap:wrap}.zr-raid-head>div>span{white-space:nowrap;text-shadow:0 2px 3px #000}</style></head>')
