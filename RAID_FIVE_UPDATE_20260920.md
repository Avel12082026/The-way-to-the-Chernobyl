...
Accumulated radiation remains on the player after bypass/finish and damages HP on subsequent travel/combat actions through the server radiation-damage function at 15% of contamination per turn (100 radiation = 15 HP). Antirad can remove it before that next action. Artifact leakage adds contamination rather than also duplicating direct HP damage.
