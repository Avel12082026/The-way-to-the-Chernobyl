...
function load(url){
 ...
 const p=new Promise((resolve,reject)=>{
  ...
  im.onload=()=>finish();im.onerror=()=>finish(new Error(url));im.src=url+'?v=20260914-modular1';
