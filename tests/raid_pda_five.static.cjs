...
assert(html.includes('ui/raid-kpk-polish.css?v=20260919r7'));
assert(html.includes('ui/raid-kpk-polish.js?v=20260919r7'));
...
assert(css.includes('aspect-ratio:3/2')&&css.includes('--raid-idle-bg'));
assert(raid.includes('RAID_IDLE_BACKGROUNDS')&&raid.includes('observeRaidLogForBackground'));
