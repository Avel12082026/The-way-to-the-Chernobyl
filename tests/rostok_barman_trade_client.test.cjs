...
assert(bunker.includes("window.BunkerMenu = {version: '1.18.0'"),'BunkerMenu version not bumped');

assert(bunker.includes('id="rostokLowerHud"')&&bunker.includes('ui/rostok-lower-hud.webp?v=ddf15c7509a3'),'Rostok clean lower menu asset missing');
...
for(const ref of [
  'ui/bunker-menu.js?v=20260923-rostok-hud2',
  'ui/bunker-menu.css?v=20260923-rostok-hud2',
