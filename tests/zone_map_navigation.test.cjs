...
assert(js.includes("version: '0.6.5'"),'ZoneMap API version mismatch');
...
assert(js.includes("1:'images/combat/environments/01.webp'")&&js.includes("2:'images/combat/environments/06.webp'")&&js.includes("3:'images/combat/environments/11.webp'")&&js.includes("4:'images/combat/environments/16.webp'"),'destination loading artwork for four current locations missing');
