...
assert(js.includes("window.BunkerMenu = {version: '1.13.0'"),'BunkerMenu API version not bumped');
...
assert(index.includes('ui/bunker-menu.css?v=20260922-barman1'));
assert(index.includes('ui/bunker-menu.js?v=20260922-barman1'));
