...
assert(js.includes("window.BunkerMenu = {version: '1.11.0'"),'BunkerMenu API version not bumped');
...
assert(index.includes('ui/bunker-menu.css?v=20260922-rostok1'));
assert(index.includes('ui/bunker-menu.js?v=20260922-rostok1'));
