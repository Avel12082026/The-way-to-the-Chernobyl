...
assert(js.includes("window.BunkerMenu = {version: '1.10.0'"),'BunkerMenu API version not bumped');
...
assert(index.includes('ui/bunker-menu.css?v=20260921-map10'));
assert(index.includes('ui/bunker-menu.js?v=20260921-map10'));
