...
assert(js.includes("window.BunkerMenu = {version: '1.4.0'"),'BunkerMenu API version not bumped');
...
assert(index.includes('ui/bunker-menu.css?v=a1f18935be31'));
assert(index.includes('ui/bunker-menu.js?v=df1fabb2c45e'));
