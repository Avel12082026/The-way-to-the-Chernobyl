...
assert(js.includes("window.BunkerMenu = {version: '1.10.1'"),'BunkerMenu API version not bumped');
...
assert(index.includes('ui/bunker-menu.css?v=20260921-map11'));
assert(index.includes('ui/bunker-menu.js?v=20260921-map11'));
