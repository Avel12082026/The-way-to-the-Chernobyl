...
assert(js.includes("window.BunkerMenu = {version: '1.18.0'"),'BunkerMenu API version not bumped');
...
assert(index.includes('ui/bunker-menu.css?v=20260923-rostok-hud2'));
assert(index.includes('ui/bunker-menu.js?v=20260923-rostok-hud2'));
