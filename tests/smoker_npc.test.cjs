...
assert(js.includes("window.BunkerMenu = {version: '1.12.0'"),'BunkerMenu API version not bumped');
...
assert(index.includes('ui/bunker-menu.css?v=20260922-rostok2'));
assert(index.includes('ui/bunker-menu.js?v=20260922-rostok2'));
