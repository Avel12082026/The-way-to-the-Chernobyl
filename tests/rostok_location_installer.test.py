...
assert mod.CACHE_KEY=='20260926-tierquests1'
...
assert 'ui/bunker-menu.css?v=20260926-tierquests1' in sample
assert 'ui/bunker-menu.js?v=20260926-tierquests1' in sample
