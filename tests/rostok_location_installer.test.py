...
assert mod.CACHE_KEY=='20260922-position3'
...
assert 'ui/bunker-menu.css?v=20260922-position3' in sample
assert 'ui/bunker-menu.js?v=20260922-position3' in sample
