...
assert mod.CACHE_KEY=='20260923-rostok-hud4'
...
assert 'ui/bunker-menu.css?v=20260923-rostok-hud4' in sample
assert 'ui/bunker-menu.js?v=20260923-rostok-hud4' in sample
