...
assert mod.CACHE_KEY=='20260926-rostok-map-hq1'
...
assert 'ui/bunker-menu.css?v=20260926-rostok-map-hq1' in sample
assert 'ui/bunker-menu.js?v=20260926-rostok-map-hq1' in sample
