...
assert mod.CACHE_KEY=='20260922-position2'
...
assert 'ui/bunker-menu.css?v=20260922-position2' in sample
assert 'ui/bunker-menu.js?v=20260922-position2' in sample
