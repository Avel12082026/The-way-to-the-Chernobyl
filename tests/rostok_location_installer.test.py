...
assert mod.CACHE_KEY=='20260925-hud-trade-final2'
...
assert 'ui/bunker-menu.css?v=20260925-hud-trade-final2' in sample
assert 'ui/bunker-menu.js?v=20260925-hud-trade-final2' in sample
