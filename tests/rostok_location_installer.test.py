...
assert mod.CACHE_KEY=='20260925-zone-travel2'
...
assert 'ui/bunker-menu.css?v=20260925-zone-travel1' in sample
assert 'ui/bunker-menu.js?v=20260925-zone-travel1' in sample
