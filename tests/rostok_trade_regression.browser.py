...
async def main():
    ...
    async with async_playwright() as pw:
        ...
        for w,h in [(390,768),(360,640),(412,915),(691,1360),(844,390)]:
            ...
            lower=await page.locator('#rostokLowerHud').bounding_box()
            ...
            if w==691:
                ...
                await page.locator('#rostokLowerHud').screenshot(path=str(OUT/'rostok-hud-after.png'))
        ...
        for value in [0,100]:
            ...
            await page.locator('#rostokLowerHud').screenshot(path=str(OUT/f'rostok-hud-{value}.png'))
