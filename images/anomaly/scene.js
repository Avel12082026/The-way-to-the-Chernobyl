...
function show(config){
 ...
 source(p.right,base+'hands/'+safeArmor+'_right.webp?v=20260914-thumb2');source(p.left,base+'hands/'+safeArmor+'_left.webp?v=20260914-thumb2');source(p.grip,base+'hands/'+safeArmor+'_right.webp?v=20260914-thumb2');
